...
export default function Home() {
  ...
  const deployButtonHandler: React.MouseEventHandler = async () => {
    try {
      ...
      if (receipt.status === 1)
        router.push(
          `/page1?contract=${'0x88c875606ae309172f89f231df5a9ffb5ad64994'}`
        );
    } catch (error) {
      console.log(error);
      ...
      <main className={styles.main}>
        ...
        <div className={styles.title}>
          <h1 className={styles.h1}>
            Simple, secure, and fast code begins here
          </h1>
        </div>
        <p className={styles.p}>
          Our web service provides a user-friendly and intuitive diamond
          constructor, empowering users to build diamonds that can be utilized
          in smart contracts. With our system, users can customize the
          properties of their diamonds, creating secure and tamper-proof
          registries that can protect their transactions. Whether you require a
          single diamond or multiple diamonds for a complex contract, our
          service delivers a versatile and reliable tool for creating diamonds
